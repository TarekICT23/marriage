...
<body>
    ...
    <div class="mainpage">
        <div class="about">
            <h2>About Us</h2> 
            <p>Welcome to Matrimony Hub, your trusted partner in lifesaving blood management solutions. Our mission is to streamline and enhance the blood donation and distribution process, ensuring that every drop counts towards saving lives. At BloodHub, we believe in the power of community and the vital role that blood donors play in healthcare</p> 
        </div>
        <div class="image">
